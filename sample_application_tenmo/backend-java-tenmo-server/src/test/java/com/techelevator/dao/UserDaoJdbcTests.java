...
import com.techelevator.tenmo.dao.UserDaoJdbc;
...
public class UserDaoJdbcTests extends BaseDaoTests {
    ...
    private UserDaoJdbc sut;

    @Before
    public void setup() {
        JdbcTemplate jdbcTemplate = new JdbcTemplate(dataSource);
        sut = new UserDaoJdbc(jdbcTemplate);
    }
