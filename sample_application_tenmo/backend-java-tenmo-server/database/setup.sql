...
DROP TABLE IF EXISTS transfer, account, tenmo_user, transfer_type, transfer_status,log_audit,log_error;
DROP TABLE IF EXISTS log_audit,log_error;
...
CREATE TABLE log_error (
                           ...
                           log_date time with time zone default current_time,
                           user_id int,
                           account_id int,
                           log_type varchar(20),
...
--
INSERT INTO tenmo_user (username,password_hash) VALUES ('rob','$2a$10$aK8vWaeQM5nGxCiKcEqbPeGYYlWXrOFv6rNY2Em7BFP9J38umSs5K');
INSERT INTO tenmo_user (username,password_hash) VALUES ('kris','$2a$10$8QprBqdc6W9nOCaNo7e/k.kU0a06.XRsI32b6eOCapTNO8JSmg6LG');
